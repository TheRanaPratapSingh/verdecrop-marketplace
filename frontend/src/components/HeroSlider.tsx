...
const SLIDES: Slide[] = [
  {
    ...
    stats: [{ value: '500+', label: 'Certified Farmers' }, { value: '2,000+', label: 'Organic Products' }, { value: '50k+', label: 'Happy Families' }],
  ...
  },
  {
    ...
    stats: [{ value: 'Rs.0', label: 'Commission (1st 100)' }, { value: '500+', label: 'Verified Farms' }, { value: '20+', label: 'Cities Covered' }],
