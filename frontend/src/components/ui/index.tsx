...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variants = {
    primary:   'bg-[#16A34A] hover:bg-[#0f8a3c] active:bg-[#0e7a35] text-[#FFFFFF] focus:ring-[#16A34A] shadow-sm hover:shadow',
    secondary: 'bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-white focus:ring-gray-400 shadow-sm',
    outline:   'border-2 border-[#16A34A] text-[#065f40] hover:bg-[#ecfdf5] active:bg-[#dcfbe9] focus:ring-[#16A34A]',
    ghost:     'text-[#1F2937] hover:bg-gray-100 active:bg-gray-200 focus:ring-[#16A34A]',
...
export const Input = forwardRef<HTMLInputElement, InputProps>(({
  ...
  <div className="flex flex-col gap-1.5">
    {label && <label className="text-sm font-medium text-[#374151] font-body leading-snug">{label}</label>}
    <div className="relative">
      ...
      <input
        ref={ref}
        className={`w-full border rounded-xl px-4 py-2.5 text-sm font-semibold font-body bg-[#F9FAFB] transition-all outline-none
          placeholder:text-[#6B7280] text-[#111827]
          ${leftIcon ? 'pl-10' : ''} ${rightIcon ? 'pr-10' : ''}
          ${error
            ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100'
            : 'border-gray-300 focus:border-[#16A34A] focus:ring-2 focus:ring-[#16A34A]/30'}
          ${className}`}
        {...props}
      />
      {rightIcon && (
