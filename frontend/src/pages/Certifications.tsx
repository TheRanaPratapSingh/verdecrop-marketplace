...
export const CertificationsPage: React.FC = () => (
  <PageLayout>
    <SEO
      ...
      description="Every product on Graamo is verified against USDA Organic, India Organic, FSSAI, Non-GMO, and Fair Trade standards. Shop with confidence."
      canonical="https://graamo.in/certifications"
    />
