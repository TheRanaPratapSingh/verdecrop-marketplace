        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinOrderQty = table.Column<decimal>(type: "decimal(8,3)", precision: 8, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "decimal(8,3)", precision: 8, scale: 3, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "Description", "DisplayOrder", "IconUrl", "IsActive", "Name", "Slug", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8141), null, 1, "🥦", true, "Vegetables", "vegetables", null },
                    { 2, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8143), null, 2, "🍎", true, "Fruits", "fruits", null },
                    { 3, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8145), null, 3, "🌾", true, "Grains & Pulses", "grains-pulses", null },
                    { 4, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8146), null, 4, "🥛", true, "Dairy", "dairy", null },
                    { 5, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8148), null, 5, "🌿", true, "Herbs & Spices", "herbs-spices", null },
                    { 6, new DateTime(2026, 3, 25, 17, 46, 18, 449, DateTimeKind.Utc).AddTicks(8150), null, 6, "🍯", true, "Honey & Jam", "honey-jam", null }
                });
